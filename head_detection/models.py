...
def get_effdet(backbone, num_classes=3, img_size=512, mode='train', pretrained=True, pretrained_backbone=False):
    if pretrained:
...
def get_effdet_test(backbone, num_classes=3, img_size=512):
    if backbone == 'ed0':
        config = get_efficientdet_config('tf_efficientdet_d0')
    elif backbone == 'ed1':
        config = get_efficientdet_config('tf_efficientdet_d1')
...
def get_effdet_pseudo(backbone, num_classes=3, img_size=512):
    if backbone == 'ed0':
        config = get_efficientdet_config('tf_efficientdet_d0')
    elif backbone == 'ed1':
        config = get_efficientdet_config('tf_efficientdet_d1')
...
def get_effdet_train(backbone, num_classes=1, img_size=512):
    if backbone == 'ed0':
        config = get_efficientdet_config('tf_efficientdet_d0')
    elif backbone == 'ed1':
        config = get_efficientdet_config('tf_efficientdet_d1')
